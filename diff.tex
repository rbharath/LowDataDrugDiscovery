...
Results are in Table~\ref{tab:tox21}. All one-shot learning methods show strong boosts over the random-forest baseline, with the \DIFdelbegin \DIFdel{Residual }\DIFdelend \DIFaddbegin \DIFadd{iterative refinement }\DIFaddend LSTM models showing a more robust boost in the presence of less data.
\begin{table}[h]
    \centering
    \begin{tabular}{ |c|c|c|c|c|c| } 
    \hline
    Tox21 & RF (50 trees) & RF (100 trees) & Siamese & AttnLSTM & \DIFdelbeginFL \DIFdelFL{ResLSTM }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{IterRefLSTM }\DIFaddendFL \\ 
    \hline
...
Results are in Table~\ref{tab:sider}. All one-shot learning methods show strong boosts over the random-forest baseline, with the \DIFdelbegin \DIFdel{Residual }\DIFdelend \DIFaddbegin \DIFadd{iterative refinement }\DIFaddend LSTM models showing a more robust boost in the presence of less data.

\begin{table}
    \centering
    \begin{tabular}{ |c|c|c|c|c|c| } 
    \hline
    SIDER & RF (50 trees) & RF (100 trees) & Siamese & AttnLSTM & \DIFdelbeginFL \DIFdelFL{ResLSTM }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{IterRefLSTM }\DIFaddendFL \\ 
    \hline
...
\begin{table}
    ...
    \begin{tabular}{ |c|c|c|c|c|c| } 
    \hline
    SIDER from Tox21 & RF (50 trees) & RF (100 trees) & Siamese & AttnLSTM & \DIFdelbeginFL \DIFdelFL{ResLSTM }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{IterRefLSTM }\DIFaddendFL \\ 
    \hline
...
The Siamese, AttnLSTM, and \DIFdelbegin \DIFdel{ResLSTM }\DIFdelend \DIFaddbegin \DIFadd{IterRefLSTM }\DIFaddend models all used the same convolutional architecture, shown in the table below, with the input starting at the left, sequentially feeding into the layers to the right.
